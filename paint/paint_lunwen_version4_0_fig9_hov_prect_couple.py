...
def lon_avg_prect(time_slice=slice(100,201),lat_slice=slice(10,20),lon_slice=slice(65,130)):
    ...
    nomarin_prect   =  xr.open_dataset(data_path + "b1850_maritime_climate_atmosphere.nc").sel(time=time_slice,lat = lat_slice,lon = lon_slice)
...
def main():
    ...
    paint_trmm_hov(trmm,path_out="/home/sun/paint/lunwen/version4.0/",filename="lunwen_fig9_v3.0_b1850_trmm_hov_prect.pdf")
    paint_model_hov(model,path_out="/home/sun/paint/lunwen/version4.0/",filename="lunwen_fig9_v3.0_b1850_model_hov_prect.pdf")
