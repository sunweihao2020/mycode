...
def lon_avg_prect(time_slice=slice(100,201),lat_slice=slice(10,20),lon_slice=slice(65,130)):
    ...
    noic_prect      =  xr.open_dataset("/home/sun/model_output/replace_somali_vin2p/average/replace_somali_climate.nc").sel(time=time_slice,lat = lat_slice,lon = lon_slice)
    ...
    nomarin_prect    =  xr.open_dataset("/home/sun/model_output/replace_marinland_vin2p/average/replace_marinland_climate.nc").sel(time=time_slice,lat = lat_slice,lon = lon_slice)
...
def main():
    ...
    paint_trmm_hov(trmm,path_out="/home/sun/paint/lunwen/version3.0/",filename="lunwen_fig9_v3.0_trmm_hov_prect.pdf")
    paint_model_hov(model,path_out="/home/sun/paint/lunwen/version3.0/",filename="lunwen_fig9_v3.0_model_hov_prect.pdf")
