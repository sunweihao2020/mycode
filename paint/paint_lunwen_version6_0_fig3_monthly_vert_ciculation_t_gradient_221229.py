...
def paint_jan_jul_tem_stream():
    ...
    for row in range(1):
        for col in range(3):
            ...
            ## diabatic heating
            im3 = ax.contour(f1.lat.data, new_level, sensible[k]*60*60*24/40,levels=[2, 4, 6, 8],colors='blue',linewidths=2.5)
    ...
    plt.savefig("/home/sun/paint/lunwen/version6.0/Jan_and_Jul_temperature_gradient_streamline_MERRA2.pdf",dpi=500)
    plt.show()
