...
def paint_meridional_stream():
    ...
    for col in range(3):
        for row in range(3):
            ...
            # plot streamfunction
            im    = ax.contourf(file0.lat.data, file0.lev.data,file0.meridional_streamfunction.data[start]/1e11,np.linspace(-2.8,2.8,29),cmap=newcmp,extend='both')
    ...
    plt.savefig('/home/sun/paint/circulation_based_on_composite_result/meridional_st_90to100_check.pdf', dpi=400)
    plt.show()
...
def paint_zonal_stream():
    ...
    for col in range(3):
        for row in range(3):
            ...
            # plot streamfunction
            im    = ax.contourf(file0.lon.data, file0.lev.data,file0.zonal_streamfunction.data[start]/1e11,np.linspace(-2.8,2.8,29),cmap=newcmp,extend='both')
    ...
    plt.savefig('/home/sun/paint/circulation_based_on_composite_result/zonal_st_10to15_check.pdf', dpi=400)
    plt.show()
...
if __name__ == "__main__":
    main()
>>>>>>> 0e8f4e9e1d47712f89e8a48f118af471c3ae7055
