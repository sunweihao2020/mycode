...
def lon_avg_prect(time_slice=slice(100,201),lat_slice=slice(10,20),lon_slice=slice(65,130)):
    ...
    nomarin_prect    =  xr.open_dataset("/home/sun/model_output/replace_inch_indian_vin2p/average/replace_marinland_climate.nc").sel(time=time_slice,lat = lat_slice,lon = lon_slice)
