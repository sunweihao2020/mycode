...
def main():
    ...
    zonal_ps =  np.load("/home/sun/data/zonal_t_gradient.npy")
    print(zonal_ps)
    ...
    ax2.plot(year,zonal_ps,color='#9bbb59',alpha=1,linewidth=4)

    add_legend()
    plt.show()

    path_out = "/home/sun/paint/" ; check_path(path_out)
    file_out = "zonal_ps_bob_time_seris_220531.pdf"
