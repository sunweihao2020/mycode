'''
2022-7-23
This script paint hov for experiment: b1850 control
'''
import sys
import xarray as xr
import numpy as np
...
def lon_avg_prect(time_slice=slice(100,201),lat_slice=slice(10,20),lon_slice=slice(65,130)):
    ...
    # model result
    control_prect   =  xr.open_dataset("/home/sun/data/model_data/climate/b1850_control_atmosphere.nc").sel(time=time_slice,lev=925,lat = lat_slice,lon = lon_slice)
...
def paint_trmm_hov(control,path_out,filename,time_slice=slice(100,201),lat_slice=slice(10,20),lon_slice=slice(65,130)):
    ...
    f0  =  xr.open_dataset("/home/sun/data/model_data/climate/b1850_control_atmosphere.nc").sel(time=time_slice,lat = lat_slice,lon = lon_slice)
    # Start figure
...
def main():
    ...
    paint_trmm_hov(control,path_out="/home/sun/paint/b1850_exp/",filename="control_hov_prect.pdf")
