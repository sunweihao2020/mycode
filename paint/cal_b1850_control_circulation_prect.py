...
def cal_pentad(path,file):
    ...
    out_set.attrs["description"]  =  "Generated in 2022-7-23. This file based on daily climate variables, is pentad average"
    ## ------------------------------------------------
...
def paint_pentad_circulation():
    ...
    for col in range(2):
        for row in range(2):
            ...
            # 加日期
            add_text(ax=ax,string="D"+str(date[j]),location=(0.90,0.91),fontsize=30)
    ...
    save_fig(path_out="/home/sun/paint/b1850_exp/",file_out="b1850_control_925_circulation_with_prect.pdf")
