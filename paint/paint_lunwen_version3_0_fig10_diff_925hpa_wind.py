...
def cal_diff_wind(lev=925,lat_slice=slice(-10,30),lon_slice=slice(45,115)):
    ...
    f1  =  xr.open_dataset("/home/sun/model_output/control_220416_vin2p/atm/average/control_220416_climate.nc").sel(lev=lev,lat=lat_slice,lon=lon_slice)
    f2  =  xr.open_dataset("/home/sun/model_output/replace_indian_vin2p/average/replace_indian_climate.nc").sel(lev=lev,lat=lat_slice,lon=lon_slice)
...
def paint_wind(wind,extent=[45,115,-10,30],lev=925,lat_slice=slice(-10,30),lon_slice=slice(45,115)):
    ...
    save_fig(path_out="/home/sun/paint/lunwen/version3.0/",file_out="lunwen_fig10_v3.0_diff_925_wind.pdf")
