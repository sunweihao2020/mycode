...
def lon_avg_prect(time_slice=slice(100,201),lat_slice=slice(10,25),lon_slice=slice(65,130)):
    ...
    return avg_trmm_prect,avg_merra_u,(avg_control_prect,avg_noic_prect,avg_noid_prect,avg_noicid_prect),(avg_control_u,avg_noic_u,avg_noid_u,avg_noicid_u)
...
def main():
    trmm,merra_u,model_prect,model_u = lon_avg_prect()
