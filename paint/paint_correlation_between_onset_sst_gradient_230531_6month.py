...
corr_file = xr.open_dataset('/home/sun/data/ERA5_data_monsoon_onset/correlation/global_correlation_bobsm_onset_SST_north_gradient.nc')

corr_list = [corr_file['corre_jan'], corr_file['corre_feb'], corr_file['corre_mar'], corr_file['corre_apr'], corr_file['corre_may'], corr_file['corre_jun']]
...
def main():
    ...
    paint_12month_correlation(corr_list, extent, corr_file['lon'], corr_file['lat'], "SST gradient(95%)")
