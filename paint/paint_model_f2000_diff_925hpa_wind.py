...
def cal_diff_wind(lev=925,lat_slice=slice(-10,30),lon_slice=slice(45,115)):
    ...
    f1  =  xr.open_dataset("/home/sun/model_output/f2000_control_220513_vin2p/average/f2000_control_climate.nc").sel(lev=lev,lat=lat_slice,lon=lon_slice)
    f2  =  xr.open_dataset("/home/sun/model_output/f2000_replace_indian_220515_vin2p/average/f2000_replace_indian_climate.nc").sel(lev=lev,lat=lat_slice,lon=lon_slice)
...
def paint_wind(wind,extent=[45,115,-10,30],lev=925,lat_slice=slice(-10,30),lon_slice=slice(45,115)):
    ...
    save_fig(path_out="/home/sun/paint/mdoel/f2000/",file_out="diff_925_wind.pdf")
