...
def paint_jan_jul_tem_stream():
    ...
    f0   =  xr.open_dataset(path0 + "b1850_maritime_atmospheric_monthly_average.nc").sel(lon=lon_slice)
    ...
    plt.savefig("/home/sun/paint/b1850_exp/monthly/Feb_to_Jul_temperature_gradient_streamline_b1850maritime.pdf",dpi=500)
    plt.show()
