...
def paint_picture(lon, lat, u, v):
    ...
    q  =  ax.quiver(lon, lat, u, v, 
                ...
                scale_units='xy', scale=0.0075,        # scale是参考矢量，所以取得越大画出来的箭头就越短
                units='xy', width=0.25,
                transform=proj,
    ...
    # 加矢量图图例
    add_vector_legend(ax=ax,q=q, speed=0.02)

    # 保存图片
    save_fig(path_out="/home/sun/paint/monthly_variable/regression/",file_out="April_925_uv_to_LSTC_index.pdf")
