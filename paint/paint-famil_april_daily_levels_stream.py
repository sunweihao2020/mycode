...
for level in levels:
    for name in exp:
        ...
        plt.tight_layout()
        plt.savefig('/home/sun/paint/famil_stream_prect/april/april_'+name+"_"+str(level)+"_1.pdf", bbox_inches='tight')
        plt.show()
        ...
        plt.tight_layout()
        plt.savefig('/home/sun/paint/famil_stream_prect/april/april_'+name+"_"+str(level)+"_2.pdf", bbox_inches='tight')
        plt.show()
    ...
    plt.tight_layout()
    plt.savefig("/home/sun/paint/famil_stream_prect/april/april_con_"+str(level)+"_1.pdf", bbox_inches='tight')
    plt.show()
    ...
    for row in range(3):
        for col in range(5):
            ...
            j += 1
    plt.tight_layout()
    plt.savefig("/home/sun/paint/famil_stream_prect/april/april_con_"+str(level)+"_2.pdf", bbox_inches='tight')
    plt.show()
    ...
    plt.tight_layout()
    plt.savefig("/home/sun/paint/famil_stream_prect/april/april_icid_"+str(level)+"_1.pdf", bbox_inches='tight')
    plt.show()
    ...
    plt.tight_layout()
    plt.savefig("/home/sun/paint/famil_stream_prect/april/april_icid_"+str(level)+"_2.pdf", bbox_inches='tight')
    plt.show()
