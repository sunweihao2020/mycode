...
year_range  =  np.array([5,42],dtype=int)

f0  =  xr.open_dataset(path_in+'b1850_tx_maritime_o1_220730.cam.h1.0017-10-02-00000.nc')
...
ds.to_netcdf(path_out+"b1850_maritime_atmosphere.nc")
