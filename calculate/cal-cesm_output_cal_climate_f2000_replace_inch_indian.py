...
start = time.time()
path_in  =  "/home/sun/model_output/f2000_replace_inch_indian_220520/vin2p/"
path_out =  "/home/sun/model_output/f2000_replace_inch_indian_220520/average/"

year_range  =  np.array([3,22],dtype=int)

f0  =  xr.open_dataset(path_in+'f2000_replace_inch_indian2.cam.h1.0009-09-27-00000.nc')
...
ds.to_netcdf(path_out+"f2000_replace_inch_indian_climate.nc")
