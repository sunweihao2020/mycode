...
start = time.time()
path_in  =  "/home/sun/model_output/replace_marinland_vin2p/vin2p/"
path_out =  "/home/sun/model_output/replace_marinland_vin2p/average/"

year_range  =  np.array([1981,2000],dtype=int)

f0  =  xr.open_dataset(path_in+'replace_marinland.cam.h1.1985-04-05-00000.nc')
...
ds.to_netcdf(path_out+"replace_marinland_climate.nc")
