...
start = time.time()
path_in  =  "/home/sun/model_output/f2000_control_220513_vin2p/vin2p/"
path_out =  "/home/sun/model_output/f2000_control_220513_vin2p/average/"

year_range  =  np.array([1981,1998],dtype=int)

f0  =  xr.open_dataset(path_in+'f2000_control_220513.cam.h1.0017-08-17-00000.nc')
...
ds.to_netcdf(path_out+"f2000_control_climate.nc")
