...
end_path  =  '/home/sun/segate/model_data/b1850_global1m/'
...
def deal_control():
    ...
    exp_name  =  ['b1850_global1m_o1_220726']
    ...
    for yyyy in range(year_length):
        ...
        for ffff in namelist[start:end]:
            ...
            yy        =  yyyy + 1
            if yy < 10:
                new_name  =  "b1850_global1m_atmosphere_h1_0" + str(yy) + "_" + ffff[(len(exp_name[0]) + len('.cam.h1.') + 5) : (len(exp_name[0]) + len('.cam.h1.') + 10)] + ".nc"
            else:
                new_name  =  "b1850_global1m_atmosphere_h1_" + str(yy) + "_" + ffff[(len(exp_name[0]) + len('.cam.h1.') + 5) : (len(exp_name[0]) + len('.cam.h1.') + 10)] + ".nc"
