...
start = time.time()
path_in  =  "/home/sun/f2000_replace_indian_220515_vin2p/"
path_out =  "/home/sun/model_output/f2000_replace_indian_220515_vin2p/average/"

year_range  =  np.array([3,22],dtype=int)

f0  =  xr.open_dataset(path_in+'change_indian_220515.cam.h1.0015-08-14-00000.nc')
...
ds.to_netcdf(path_out+"f2000_replace_indian_climate.nc")
