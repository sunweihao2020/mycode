...
path0  =  '/home/sun/model_output/f2000_ensemble/'
...
def cal_ensemble_avg_2d(var_name,start_num=1,end_num=20):
    ...
    for i in range(start_num,end_num + 1): 
        # ensemble exps loop
        path1  =  path0 + 'f2000_ensemble_' + str(i) + '/atm/hist/'

        # get the file list
        list1    =  os.listdir(path1)
        list_h0  =  []
        for ffff in list1:
            if '.cam.h0.0001' in ffff:
                list_h0.append(ffff)
        list_h0.sort()
...
def deal_with_output():
    ...
    for vvvv in variable:
        ...
        if dim0 == 3:
            ...
            ncfile.to_netcdf("/home/sun/data/model_data/f2000_ensemble/"+vvvv+'_climate.nc')
